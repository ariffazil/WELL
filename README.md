...
live_commit: 33c837f (docs(readme): readiness-first repositioning)
tools_live: 31 (canonical, live-witnessed 2026-08-25 via :18083/health)
authority_ceiling: REFLECT_ONLY
truth_rule: live :18083/health + tools/list beat any static count in prose
owner_summary: YELLOW (biometric_override, vitality_degraded — honest by design)
readme_note: ZEN readiness-first — full technical README preserved at docs/README-FULL.md
-->
...
Live banner (2026-08-25, `:18083/health`):
...
Status degraded — biometric source is mock/test data, not live sensor feeds. Reduced confidence in readiness assessment. Proceed with awareness.
